...
@allure.feature('自动化标注功能')
class TestAutolabel:
    """自动标注测试类"""
    @allure.story('自动标注功能')
    @allure.title('检测算法自动标注')
    @pytest.mark.smoke
    def test_det_autolabel(self):  
        name = 'DET自动标注'  #方案名称
    ...
    @pytest.mark.smoke
    def test_UADOCR_autolabel(self): 
        name = 'UAD_OCR自动标注'
    ...
    @pytest.mark.smoke
    def test_CLSOCR_autolabel(self): 
        name = 'CLS_OCR自动标注'
    ...
    @pytest.mark.smoke
    def test_seqOCR_autolabel(self):  
